...
Como lo indica el titulo, vamos a transformar una imagen con la matríz o máscara de convolución Sobel Left, la cual esta representada de esta manera:
...
Finalmente como resultado obtenemos la imagen transfromada usando la matriz de Sobel Left.
