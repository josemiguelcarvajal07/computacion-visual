...
<img src="../images/Blur-matrix.svg" alt="Blur Matrix" class="center-matrix">

Esta es la imagen que vamos a transformar, como podemos observar esta es una imagen de un Tucán.

<img src="../images/Toucan.jpg" alt="Toucan" class="center-image">
...
function preload() {
    img = loadImage('../images/Toucan.jpg');
}
...
```
Finalmente como resultado obtenemos la imagen un poco mas borrosa.
...
<div class="sketch-box-blur" id='box-blur'></div>